...
@Theme("valo")
public class LazyComboBoxUsageSampleNoLowercasing extends AbstractTest {

    @Override
    public String getDescription() {
        return "Uses raw filter mode, so component doesn't lowecase search term like ComboBox in Vaadin by default does. Shouldn't find anyting unless using lowercase as the service expects lowercase...";
    }

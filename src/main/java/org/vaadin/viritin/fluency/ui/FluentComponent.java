...
public interface FluentComponent<S extends FluentComponent<S>>
        extends Component, FluentSizeable<S> {
     ...
     */
    public default S withCaption(String caption) {
        ((Component) this).setCaption(caption);
        return (S) this;
    }
     ...
     */
    public default S withEnabled(boolean enabled) {
     ...
     */
    public default S withIcon(Resource icon) {
        ((Component) this).setIcon(icon);
        return (S) this;
    }
     ...
     */
    public default S withId(String id) {
     ...
     */
    public default S withPrimaryStyleName(String style) {
        ((Component) this).setPrimaryStyleName(style);
        return (S) this;
    }
     ...
     * @see #isVisible()
     */
    public default S withVisible(boolean visible) {

...
public class MGrid extends Grid{
	...
	/**
	 * Enables saving/loading grid settings (visible columns, sort order, etc) to cookies.
	 * @param settingsName cookie name where settings are saved should be unique.
	 */

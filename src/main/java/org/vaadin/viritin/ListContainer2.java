 ...
 */
public class ListContainer2<T> extends AbstractContainer implements
    ...
    public ListContainer2(Collection<? extends T> backingList) {
        setCollection(backingList);
    }

    public ListContainer2(Class<? extends T> type, Collection<? extends T> backingList) {
        if (type != null) {
    ...
    public ListContainer2(Class<? extends T> type) {
        backingList = new ArrayList<>();
        dynaClass = WrapDynaClass.createDynaClass(type);
    }

    public ListContainer2(Class<? extends T> type, String... properties) {
        this(type);
            ...
            if (getDynaClass() != null) {
                ...
                for (DynaProperty db : getDynaClass().getDynaProperties()) {
                    if (db.getType() != null) {
                        ...
                        Logger.getLogger(ListContainer2.class.getName()).log(
    ...
    public ListContainer2 addAll(Collection<T> beans) {
    ...
    public class DynaBeanItem<T> implements Item {
        ...
        private class DynaProperty implements Property {
            ...
            public Class getType() {
                return ListContainer2.this.getType(propertyName);
            }
        ...
        public Collection<String> getItemPropertyIds() {
            return ListContainer2.this.getContainerPropertyIds();
        }
